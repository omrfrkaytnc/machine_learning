...
df_ = pd.read_csv("4 -) RECOMMENDATION PROBLEMS/datasets/armut_data.csv")
df = df_.copy()
df.head()
...
#########################
# GÖREV 2: Birliktelik Kuralları Üretiniz ve öneride bulunun
#########################
...
# tüm olasılıkları çıkardıktan sonra kuralları oluşturacağız:
